...
#CHECK: risblgz	%r0, %r0, 0, 255, 0     # encoding: [0xec,0x00,0x00,0xff,0x00,0x51]
...
#CHECK: risblg	%r0, %r0, 0, 0, 127     # encoding: [0xec,0x00,0x00,0x00,0x7f,0x51]
#CHECK: risblgz	%r0, %r0, 0, 127, 0     # encoding: [0xec,0x00,0x00,0xff,0x00,0x51]
#CHECK: risblg 	%r0, %r0, 0, 127, 0     # encoding: [0xec,0x00,0x00,0x7f,0x00,0x51]
#CHECK: risblg	%r0, %r0, 127, 0, 0     # encoding: [0xec,0x00,0x7f,0x00,0x00,0x51]
...
#CHECK: risblgz	%r4, %r5, 6, 7, 8       # encoding: [0xec,0x45,0x06,0x87,0x08,0x51]
#CHECK: llhfr	%r0, %r1                # encoding: [0xec,0x01,0x00,0x9f,0x20,0x51]
#CHECK: llhlhr	%r2, %r3                # encoding: [0xec,0x23,0x10,0x9f,0x20,0x51]
#CHECK: llclhr	%r4, %r5                # encoding: [0xec,0x45,0x18,0x9f,0x20,0x51]

	risblg	%r0,%r0,0,0,0
	risblg	%r0,%r0,0,0,63
	risblg	%r0,%r0,0,0,64
	risblg	%r0,%r0,0,0,255
	risblgz	%r0,%r0,0,255,0
	risblg	%r0,%r0,0,255,0
	risblg	%r0,%r0,255,0,0
	risblg	%r0,%r0,0,0,127
	risblgz	%r0,%r0,0,127,0
	risblg	%r0,%r0,0,127,0
	risblg	%r0,%r0,127,0,0
	risblg	%r0,%r15,0,0,0
	risblg	%r15,%r0,0,0,0
	risblg	%r4,%r5,6,7,8
	risblgz	%r4,%r5,6,7,8
...
#CHECK: risbhgz	%r0, %r0, 0, 255, 0     # encoding: [0xec,0x00,0x00,0xff,0x00,0x5d]
...
#CHECK: risbhg	%r0, %r0, 0, 0, 127     # encoding: [0xec,0x00,0x00,0x00,0x7f,0x5d]
#CHECK: risbhgz	%r0, %r0, 0, 127, 0     # encoding: [0xec,0x00,0x00,0xff,0x00,0x5d]
#CHECK: risbhg 	%r0, %r0, 0, 127, 0     # encoding: [0xec,0x00,0x00,0x7f,0x00,0x5d]
#CHECK: risbhg	%r0, %r0, 127, 0, 0     # encoding: [0xec,0x00,0x7f,0x00,0x00,0x5d]
...
#CHECK: risbhgz	%r4, %r5, 6, 7, 8       # encoding: [0xec,0x45,0x06,0x87,0x08,0x5d]
#CHECK: lhhr	%r0, %r1                # encoding: [0xec,0x01,0x00,0x9f,0x00,0x5d]
#CHECK: lhlr	%r2, %r3                # encoding: [0xec,0x23,0x00,0x9f,0x20,0x5d]
#CHECK: llhhhr	%r4, %r5                # encoding: [0xec,0x45,0x10,0x9f,0x00,0x5d]
#CHECK: llhhlr	%r6, %r7                # encoding: [0xec,0x67,0x10,0x9f,0x20,0x5d]
#CHECK: llchhr	%r8, %r9                # encoding: [0xec,0x89,0x18,0x9f,0x00,0x5d]
#CHECK: llchlr	%r10, %r11              # encoding: [0xec,0xab,0x18,0x9f,0x20,0x5d]

	risbhg	%r0,%r0,0,0,0
	risbhg	%r0,%r0,0,0,63
	risbhg	%r0,%r0,0,0,64
	risbhg	%r0,%r0,0,0,255
	risbhgz	%r0,%r0,0,255,0
	risbhg	%r0,%r0,0,255,0
	risbhg	%r0,%r0,255,0,0
	risbhg	%r0,%r0,0,0,127
	risbhgz	%r0,%r0,0,127,0
	risbhg	%r0,%r0,0,127,0
	risbhg	%r0,%r0,127,0,0
	risbhg	%r0,%r15,0,0,0
	risbhg	%r15,%r0,0,0,0
	risbhg	%r4,%r5,6,7,8
	risbhgz	%r4,%r5,6,7,8
